...
export const AboutAndSkills: React.FC = () => {
  const skills = [
    "SOC Operations", "Threat Monitoring", "Incident Response", "Log Analysis", "SIEM",
    "Network Security", "Linux", "Python", "Wireshark", "Nmap", "React", "Vite",
    "JavaScript", "HTML", "CSS", "SEO", "UI/UX Design", "Git", "GitHub"
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-6 rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/40 p-6 sm:p-8 backdrop-blur-md relative overflow-hidden group">
            ...
            <p className="text-gray-600 dark:text-zinc-300 leading-relaxed text-left font-sans text-sm md:text-base">
              Frontend Developer with experience in building responsive web interfaces using React and Vite. Skilled in UI/UX design, SEO, and content optimization. Strong interest in cybersecurity, threat detection, and security monitoring. Built a full-stack URL Threat Evaluation and Risk Scoring System integrating security checks and machine learning to detect and classify potential threats.
            </p>
          </div>
